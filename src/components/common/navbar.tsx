...
const defaultNavigationLinks: Navbar05NavItem[] = [
    { href: '/document-management', label: 'Document Manager' },
    { href: '/users', label: 'User Manager' },
];

export const Navbar = React.forwardRef<HTMLElement, Navbar05Props>(
    (
        {
            className,
            logo = <Logo />,
        ...
        const handleMobileNavigationClick = (e: React.MouseEvent, href?: string) => {
            if (href && href !== '#' && href !== pathname) {
                e.preventDefault();
                onNavItemClick?.(href);
                router.push(href);
                                            ...
                                            <NavigationMenuItem key={index}>
                                                <NavigationMenuLink asChild>
                                                    <Link
                                                        ...
                                                        className={cn(
                                                            "font-medium transition-colors cursor-pointer group inline-flex h-10 w-max items-center justify-center rounded-md bg-background px-4 py-2 text-sm focus:bg-accent focus:text-accent-foreground focus:outline-none disabled:pointer-events-none disabled:opacity-50",
                                                            pathname === link.href 
